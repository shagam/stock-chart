    ...
    <div style={{ border: '2px solid blue'}}> 
      ...
      {props.chartSymbol && <div>
          ...
          <div>  
            ...
            {holdingsRawObj[props.chartSymbol] && <button style={{background: 'Chartreuse'}} type="button" onClick={()=>holdingsInsertInTable ()}>insert-in-table &nbsp; {props.chartSymbol} </button> } &nbsp;
          </div> 
          <div>&nbsp; </div>
        </div>
      }
