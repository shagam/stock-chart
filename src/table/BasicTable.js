...
const BasicTable = (props) => {
  ...
  "EVToEBITDA","EVToRevenue","price","year10","year20",'short','peak2Peak',"splits_list","splits",
...
// get stock overview
 ...
 const [nonSymTool, setNonSymTool] = useState('none')
  ...
  return (
    ...
    <>
        <div style={{color: 'red', fontWeight: "bold", fontSize: "1.4em"}}>Still working on backend server problem; use test backEnd </div>
