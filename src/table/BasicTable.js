...
const BasicTable = (props) => {
  ...
  const [servSelect, setServSelect] = useState(servList[0]);  // default test server
  ...
  "EVToEBITDA","EVToRevenue","price","mon","year10","year20",'short','peak2Peak',"splits_list","splits",
  "target","info_date","gap","gain_date","deep","recoverWeek","deepDate","bubblePrice","verify_1"] 
  ...
  return (
    ...
    <>
        ...
        <div id="buttons_id" style={{display:'flex'}}>
          ...
          {<div> <button style={{backgroundColor: '#bbffbb'}} onClick={gainAll} title='fetch and fill table with gain values' > gainMultiple </button> </div>} &nbsp;&nbsp;
